		...
		<div className="editbook">
			<div>
				...
				<form onSubmit={handleSubmit(editBook)}>
					...
					<label>
						<p>Author</p>
						<input type="text" name="author" defaultValue={book.author}{...register("author")} />
					</label>
					<label>
						<p>Genre</p>
						<input type="text" name="genre" defaultValue={book.genre}{...register("genre")} />
					</label>
					<label>
						<p>Synopsis</p>
						<input type="text" name="synopsis" defaultValue={book.synopsis}{...register("synopsis")} />
					</label>
					<ReusableButton
						text="Edit"
					/>
